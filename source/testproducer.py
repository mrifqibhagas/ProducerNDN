...
cred = credentials.Certificate("medical-record-7557a-firebase-adminsdk-bnaep-ee0229ec92.json") # mendefinisikan kredensial Firebase yang digunakan untuk otentikasi dan berinteraksi dengan layanan Firebase
